...
class DiagramFactory {
    ...
    Diagram buildDiagram(Materials material) {
        ...
        insertFluidIntoSlot(
                ...
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypefluid"));
        insertFluidIntoSlot(
                fluidsSlotBuilder, material.getGas(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypegas"));
        insertFluidIntoSlot(
                fluidsSlotBuilder, material.getSolid(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypesolid"));
        insertFluidIntoSlot(
                fluidsSlotBuilder, material.getMolten(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypemolten"));
        insertFluidIntoSlot(
                fluidsSlotBuilder, material.getPlasma(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypeplasma"));
        ...
        insertFluidIntoSlot(
                ...
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypelightlyhydrocracked"));
        insertFluidIntoSlot(
                hydroCrackedFluidsSlotBuilder, material.getModeratelyHydroCracked(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypemoderatelyhydrocracked"));
        insertFluidIntoSlot(
                hydroCrackedFluidsSlotBuilder, material.getSeverelyHydroCracked(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypeseverelyhydrocracked"));
        ...
        insertFluidIntoSlot(
                ...
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypelightlysteamcracked"));
        insertFluidIntoSlot(
                steamCrackedFluidsSlotBuilder, material.getModeratelySteamCracked(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypemoderatelysteamcracked"));
        insertFluidIntoSlot(
                steamCrackedFluidsSlotBuilder, material.getSeverelySteamCracked(1000),
                Lang.GREGTECH_MATERIAL_PARTS.trans("fluidtypeseverelysteamcracked"));
        ...
        if (material.isRadioactive() || material.mHeatDamage != 0) {
            ...
            if (material.isRadioactive()) {
                tooltipBuilder.addTextLine(
                        Lang.GREGTECH_MATERIAL_PARTS.trans("materialinforadioactive"));
            }
            if (material.mHeatDamage > 0) {
                tooltipBuilder.addTextLine(
                        Lang.GREGTECH_MATERIAL_PARTS.trans("materialinfohot"));
            } else if (material.mHeatDamage < 0) {
                tooltipBuilder.addTextLine(
                        Lang.GREGTECH_MATERIAL_PARTS.trans("materialinfocold"));
            }
        }
